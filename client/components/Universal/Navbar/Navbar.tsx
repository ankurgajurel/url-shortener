export default function Navbar() {
  return (
    <>
      <header className="flex justify-start flex-nowrap z-50 w-full text-sm">
        <nav className="flex items-center mt-6 relative max-w-[85rem] w-full bg-white border border-gray-200 rounded-[36px] mx-2 py-3 px-10 md:items-center justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto">
          ...
          <div className=" transition-all duration-300 basis-full grow">
            <div className="flex items-center justify-end gap-x-7">
              ...
              <a
                className="hidden md:flex items-center gap-2 font-medium text-gray-500 hover:text-blue-600 md:border-s md:border-gray-300 md:my-6 md:ps-6"
